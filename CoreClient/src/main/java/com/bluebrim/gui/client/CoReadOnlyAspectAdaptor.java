...
/**
 	Abstrakt subklass till CoAspectAdaptor som implementeras då man 
 	bara är intresserad av att hämta ett värde från verksamhetsobjektet.
 	Dvs #set är implementerad som en NOP.
 */
