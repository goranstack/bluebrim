 ...
 */
final private int convertRowToY(int row, int listSize)
{
	int nrows = listSize;
 ...
 * @see #updateLayoutState
 */
final private int convertYToRow(int y0, int listSize)
{
	int nrows = listSize;
	Insets insets = list.getInsets();
	if (cellHeights == null)
...
protected MouseInputListener createMouseInputListener()
{
	 ...
	 */
	final private Rectangle getCellBounds(int index1, int index2, int listSize) {
	 ...
	 * @see ListUI#getCellBounds
	 */
	final public Rectangle getCellBounds(JList list, int index1, int index2, int listSize) {
...
final private CoList getList()
{
	return (CoList )list;
}
final private int getListSize()
{
...
public Dimension getPreferredSize(JComponent c) 
{
	 ...
	 * @see #updateLayoutState
	 */
	final private int getRowHeight(int row, int listSize) 
	{
...
final private void maybeUpdateLayoutState(int listSize) 
{
...
{
//	System.out.println("=>CoBasicListUI.paint");
