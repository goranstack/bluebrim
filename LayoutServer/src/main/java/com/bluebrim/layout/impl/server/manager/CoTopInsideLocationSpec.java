...
public class CoTopInsideLocationSpec extends CoCornerLocationSpec
{
	public static final String XML_TAG = "top-inside-location";
/*
 * Used at XML import
...
{
	return new CoTopInsideLocationSpec( node, context );
}
 ...
 */
public CoTopInsideLocationSpec() {}
...
protected CoTopInsideLocationSpec( Node node, com.bluebrim.xml.shared.CoXmlContext context ) 
{
	super( node, context );
