...
public class CoBoundingBoxRunAroundSpec extends CoRunAroundSpec implements CoBoundingBoxRunAroundSpecIF
{
	...
	{
		public double getLeft(){ return CoBoundingBoxRunAroundSpec.this.getLeft(); }
		public double getRight(){ return CoBoundingBoxRunAroundSpec.this.getRight(); }
		public double getTop(){ return CoBoundingBoxRunAroundSpec.this.getTop(); }
		public double getBottom(){ return CoBoundingBoxRunAroundSpec.this.getBottom(); }
...
public CoImmutableShapeIF getRunAroundShape( CoShapePageItem pi )
{
	...
	return new CoRectangleShape( r.getX() - m_left,
		                           r.getY() - m_top,
		                           r.getWidth() + m_left + m_right,
		                           r.getHeight() + m_top + m_bottom );
}
