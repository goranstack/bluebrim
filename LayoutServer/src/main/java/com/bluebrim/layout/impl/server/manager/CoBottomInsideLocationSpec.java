...
public class CoBottomInsideLocationSpec extends CoCornerLocationSpec
{
/*
...
protected CoBottomInsideLocationSpec(Node node, com.bluebrim.xml.shared.CoXmlContext context) 
{
	super( node, context );

	// xml init
}
	public static final String XML_TAG = "bottom-inside-location";

/**
 * Insert the method's description here.
 * Creation date: (2000-09-20 15:41:07)
 */
public CoBottomInsideLocationSpec() {}
...
{
	return new CoBottomInsideLocationSpec( node, context );
}
}