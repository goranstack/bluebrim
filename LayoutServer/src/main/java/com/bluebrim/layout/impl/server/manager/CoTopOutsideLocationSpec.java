...
public class CoTopOutsideLocationSpec extends CoCornerLocationSpec
{
	public static final String XML_TAG = "top-outside-location";
/*
 * Used at XML import
...
{
	return new CoTopOutsideLocationSpec( node, context );
}
 ...
 */
public CoTopOutsideLocationSpec() {}
...
protected CoTopOutsideLocationSpec( Node node, com.bluebrim.xml.shared.CoXmlContext context ) 
{
	super( node, context );
