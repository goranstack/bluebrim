...
public void xmlAddSubModel( String name, Object subModel, com.bluebrim.xml.shared.CoXmlContext context )
{
	...
	protected class MutableProxy implements CoRemoteFillStyleIF
	{
		...
		public void removePropertyChangeListener( CoPropertyChangeListener l ) { CoFillStyle.this.removePropertyChangeListener( l ); }
		public void addPropertyChangeListener( CoPropertyChangeListener l ) { CoFillStyle.this.addPropertyChangeListener( l ); }
		public CoFillStyleIF deepClone() { return CoFillStyle.this.deepClone(); }
		public String getFactoryKey() { return CoFillStyle.this.getFactoryKey(); }
		public Paint getPaint( Rectangle2D bounds ) { return CoFillStyle.this.getPaint( bounds ); }
	}
