...
public class CoEqualNode extends CoBinaryNode {
public CoEqualNode(CoFormulaNode leftNode, CoFormulaNode rightNode) {
...
public String getIncorrectTypeErrorMessage () {
	return CoFormulaErrorResources.INCORRECT_USE_OF_OPERATOR_EQUAL;
}
