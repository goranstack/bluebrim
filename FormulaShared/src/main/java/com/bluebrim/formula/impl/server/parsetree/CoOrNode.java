...
public class CoOrNode extends CoBinaryNode {
public CoOrNode(CoFormulaNode leftNode, CoFormulaNode rightNode) {
...
public String getIncorrectTypeErrorMessage () {
	return CoFormulaErrorResources.INCORRECT_USE_OF_OPERATOR_OR;
}
protected String getOperator() {
	return " " + CoFormulaScanner.RESERVED_WORD_OR + " ";
}
}
