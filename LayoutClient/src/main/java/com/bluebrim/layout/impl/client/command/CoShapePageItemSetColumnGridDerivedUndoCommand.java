...
public boolean doUndo()
{
	...
	if
		( m_columnGrid != null )
	{
		m_target.getMutableColumnGrid().set( 
			m_columnGrid.getColumnCount(),
			m_columnGrid.getColumnSpacing(),
			m_columnGrid.getLeftMargin(),
			m_columnGrid.getTopMargin(),
			m_columnGrid.getRightMargin(),
			m_columnGrid.getBottomMargin()
		);
	}
