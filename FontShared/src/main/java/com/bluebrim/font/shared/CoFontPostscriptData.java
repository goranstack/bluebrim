...
public interface CoFontPostscriptData extends Serializable, com.bluebrim.xml.shared.CoXmlEnabledIF {
	public final static String XML_TAG = "font-postscript-data";
	public final static String XML_POSTSCRIPT_NAME = "name";
	public final static String XML_POSTSCRIPT_DEFINITION = "data";
