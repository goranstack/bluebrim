...
{
	// apply handle translations to corners and sides
	
	return new CoReshapeHandleIF[]
	{
		new CoReshapeHandleIF() // upper left
		{
			public final double getX() { return CoBoundingShape.this.getX(); }
			public final double getY() { return CoBoundingShape.this.getY(); }
			public final int getEdgeMask() { return ( ( getWidth() >= 0 ) ? LEFT_EDGE_MASK : RIGHT_EDGE_MASK ) | 
				                                      ( ( getHeight() >= 0 ) ? TOP_EDGE_MASK : BOTTOM_EDGE_MASK ); }
		...
		{
			public final double getX() { return CoBoundingShape.this.getX() + getWidth() / 2; }
			public final double getY() { return CoBoundingShape.this.getY(); }
			public final int getEdgeMask() { return ( getHeight() >= 0 ) ? TOP_EDGE_MASK : BOTTOM_EDGE_MASK; }
			public final void move( double dx, double dy )
			{
				double w = getWidth();
				double h = getHeight();
		...
		{
			public final double getX() { return CoBoundingShape.this.getX() + getWidth(); }
			public final double getY() { return CoBoundingShape.this.getY(); }
			public final int getEdgeMask() { return ( ( getWidth() >= 0 ) ? RIGHT_EDGE_MASK : LEFT_EDGE_MASK ) | 
				                                      ( ( getHeight() >= 0 ) ? TOP_EDGE_MASK : BOTTOM_EDGE_MASK ); }
			public final void move( double dx, double dy )
			{
				double w = getWidth() + dx;
		...
		{
			public final double getX() { return CoBoundingShape.this.getX() + getWidth(); }
			public final double getY() { return CoBoundingShape.this.getY() + getHeight() / 2; }
			public final int getEdgeMask() { return ( getWidth() >= 0 ) ? RIGHT_EDGE_MASK : LEFT_EDGE_MASK; }
			public final void move( double dx, double dy )
			{
				double w = getWidth();
		...
		{
			public final double getX() { return CoBoundingShape.this.getX() + getWidth(); }
			public final double getY() { return CoBoundingShape.this.getY() + getHeight(); }
			public final int getEdgeMask() { return ( ( getWidth() >= 0 ) ? RIGHT_EDGE_MASK : LEFT_EDGE_MASK ) | 
				                                      ( ( getHeight() >= 0 ) ? BOTTOM_EDGE_MASK : TOP_EDGE_MASK ); }
			public final void move( double dx, double dy )
			{
				double w = getWidth() + dx;
				double h = getHeight() + dy;
		...
		new CoReshapeHandleIF() // lower
		{
			public final double getX() { return CoBoundingShape.this.getX() + getWidth() / 2; }
			public final double getY() { return CoBoundingShape.this.getY() + getHeight(); }
			public final int getEdgeMask() { return ( getHeight() >= 0 ) ? BOTTOM_EDGE_MASK : TOP_EDGE_MASK; }
			public final void move( double dx, double dy )
			{
				double w = getWidth();
				double h = getHeight();
