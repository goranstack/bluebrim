...
public abstract class CoAbstractLineBreaker extends com.bluebrim.base.shared.CoObject implements CoLineBreakerIF
{
	...
	{
		public void addPropertyChangeListener( CoPropertyChangeListener l ) { CoAbstractLineBreaker.this.addPropertyChangeListener( l ); }
		public void removePropertyChangeListener( CoPropertyChangeListener l ) { CoAbstractLineBreaker.this.removePropertyChangeListener( l ); }
		public final CoMutableLineBreakerIF getMutableProxy() { return CoAbstractLineBreaker.this.getMutableProxy(); }
		public final String getFactoryKey() { return CoAbstractLineBreaker.this.getFactoryKey(); }
		public CoLineBreakerIF.BreakPointIteratorIF getBreakPoints( Segment text ) { return CoAbstractLineBreaker.this.getBreakPoints( text ); }
		public String getUIname() { return CoAbstractLineBreaker.this.getUIname(); }
		public void xmlVisit( com.bluebrim.xml.shared.CoXmlVisitorIF v ) { CoAbstractLineBreaker.this.xmlVisit( v ); }
		public void xmlImportFinished( Node node, com.bluebrim.xml.shared.CoXmlContext context ) throws com.bluebrim.xml.shared.CoXmlReadException { CoAbstractLineBreaker.this.xmlImportFinished( node, context ); }
		public void xmlAddSubModel( String parameter, Object subModel, com.bluebrim.xml.shared.CoXmlContext context ) throws com.bluebrim.xml.shared.CoXmlReadException { CoAbstractLineBreaker.this.xmlAddSubModel( parameter, subModel, context ); }
	};
